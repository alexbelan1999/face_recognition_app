...
class Ui_Training(object):
    def setupUi(self, Training):
        ...
        self.lineEdit_file.setGeometry(QtCore.QRect(50, 60, 410, 30))
        self.lineEdit_file.setFont(font)
        self.lineEdit_file.setObjectName("lineEdit_file")

        self.pushButton_dir = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_dir.setGeometry(QtCore.QRect(50, 100, 410, 30))
        ...
        self.lineEdit_dir.setGeometry(QtCore.QRect(50, 180, 410, 30))
