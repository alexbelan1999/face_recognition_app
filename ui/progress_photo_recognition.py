...
class Ui_Progress_photo_recognition(object):
    def setupUi(self, Progress_photo_recognition):
        ...
        self.centralwidget = QtWidgets.QWidget(Progress_photo_recognition)
        ...
        Progress_photo_recognition.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(Progress_photo_recognition)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 21))
        self.menubar.setObjectName("menubar")
        Progress_photo_recognition.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(Progress_photo_recognition)
        self.statusbar.setObjectName("statusbar")
        Progress_photo_recognition.setStatusBar(self.statusbar)

        self.retranslateUi(Progress_photo_recognition)
        QtCore.QMetaObject.connectSlotsByName(Progress_photo_recognition)
    ...
    def retranslateUi(self, Progress_photo_recognition):
        ...
        self.pushButton_start.setText(_translate("Progress_photo_recognition", "Начало распознавания"))
        self.pushButton_report.setText(_translate("Progress_photo_recognition", "Отправить отчет"))
        self.pushButton_add.setText(_translate("Progress_photo_recognition", "Добавить студента"))
